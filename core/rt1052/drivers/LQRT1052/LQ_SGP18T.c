...
#define TFTSPI_CS     PT2_19    //CS   D11
#define TFTSPI_SCL    PT2_21    //SCL  D12
#define TFTSPI_SDA    PT2_20    //SDI  E12
#define TFTSPI_DC     PT2_15    //DC   E11
#define TFTSPI_RST    PT2_26    //RST  B13
...
{ 
  ...
  while(Del--)
  {	
    for(i=0;i<3;i++) __asm("NOP");//RT1052 528M: 30000是1ms,30是1M
  }
}
...
{ 
  ...
  /* 显示图片 */
//  TFTSPI_Show_Pic2(0, 0, 128, 160, MYPIC);
